(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".section-portfolio__slider")) new swiper_core_Swiper(".section-portfolio__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".section-portfolio__arrow-left",
                    nextEl: ".section-portfolio__arrow-right"
                },
                on: {}
            });
        }
